...
CREATE TABLE IF NOT EXISTS `elegance`.`productos` (
  ...
  PRIMARY KEY (`ID`, `categorias_ID`, `marcas_ID`, `colors_ID`),
...
-- -----------------------------------------------------
-- Table `elegance`.`apartado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `elegance`.`apartado` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `fecha` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `elegance`.`pagos_apartados` (
  ...
  CONSTRAINT `fk_pagos_apartados_apartado1`
    ...
    REFERENCES `elegance`.`apartado` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
